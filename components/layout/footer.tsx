...
export default async function Footer() {
  ...
  return (
    <footer className="font-brightness text-base  text-sm text-neutral-500 dark:text-neutral-400">
      ...
      <div className="border-t border-neutral-200 py-6 text-sm dark:border-neutral-700">
        <div className="mx-auto flex w-full max-w-7xl flex-col items-center gap-1 px-4 md:flex-row md:gap-0 md:px-4 xl:px-0">
          ...
          <p>Designed in Bogotá</p>
          <p className="md:ml-auto">
            Created by{' '}
            <a
              href="https://www.instagram.com/pizpiretamakeup"
